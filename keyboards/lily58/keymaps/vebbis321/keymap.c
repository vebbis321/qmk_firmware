...
KC_LSFT,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_LBRC, KC_RCBR, KC_MINS,  KC_EQL, KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS,
                         KC_RALT, KC_LALT, KC_LGUI,     RSFT_T(KC_ENT), KC_SPC,   MO(_LOWER), MO(_RAISE), KC_RALT
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
       KC_TAB, KC_MPRV, KC_MPLY, KC_MNXT , XXXXXXX, KC_PSCR,                   KC_BRID, KC_BRIU, KC_MUTE, KC_VOLD, KC_VOLU, KC_BSPC,
CTL_T(KC_ESC),   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                   KC_LEFT, KC_DOWN, KC_UP,KC_RGHT, KC_HOME, KC_PGUP,
KC_LSFT,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10, KC_LBRC, KC_RBRC,  KC_F11,  KC_F12, XXXXXXX,  XXXXXXX, KC_END, KC_PGDN,
                         KC_RALT, KC_LALT, KC_LGUI,     RSFT_T(KC_ENT), KC_SPC,   MO(_LOWER), MO(_RAISE), KC_RALT
)
};
